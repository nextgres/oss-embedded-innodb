...
UNIV_STATIC ibool		os_sync_mutex_inited	= FALSE;
/** TRUE when os_sync_free() is being executed */
UNIV_STATIC ibool		os_sync_free_called	= FALSE;
...
UNIV_STATIC UT_LIST_BASE_NODE_T(os_event_struct_t)	os_event_list;

/** The list of all OS 'slow' mutexes */
UNIV_STATIC UT_LIST_BASE_NODE_T(os_mutex_str_t)	os_mutex_list;
...
UNIV_STATIC void os_event_free_internal(os_event_t	event);
